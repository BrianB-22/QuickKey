    ...
    static let nano = AppShortcuts(
        ...
        categories: [
            ...
            ShortcutCategory(name: "Edit", shortcuts: [
                ...
                Shortcut(name: "Delete character forward", keys: "⌃+D",       description: "Deletes the character under the cursor (forward delete)."),
                Shortcut(name: "Cut to end of buffer",   keys: "⌥+T",         description: "Cuts everything from the cursor position to the end of the file."),
                ...
                Shortcut(name: "Comment/uncomment line", keys: "⌥+3",         description: "Toggles a comment character on the current line (nano 4.0+)."),
            ...
            ShortcutCategory(name: "Misc", shortcuts: [
                ...
                Shortcut(name: "Word count",             keys: "⌥+D",         description: "Displays the word, line, and character count of the buffer in the status bar."),
                Shortcut(name: "Refresh screen",         keys: "⌃+L",         description: "Redraws the screen and centers the current line in the middle of the window."),
